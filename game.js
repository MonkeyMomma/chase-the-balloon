...
bgImage.onload = function () {
  ...
  Photo by Mia P on FreeImages https://freeimages.com/photographer/chokingxl-68541
  */
  bgReady = true;
};
bgImage.src = "img/beachbackground.jpg";
// Load the hero image
var heroReady = false;
...
var render = function () {
  ...
  ctx.fillText("Balloons caught and animals saved: " + monstersCaught, 20, 20);
